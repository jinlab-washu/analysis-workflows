...
OUT_DIR=/storage1/fs1/jin810/Active/pb_runs/"$project_name"/pb_germline_output/interactive
TMP_DIR=/scratch1/fs1/jin810/pb_runs_scratch/"$project_name"/interactive
...
bsub -G compute-jin810 -n 16 -M 64GB -R 'rusage[mem=64GB] span[hosts=1]' \
-Is -q general-interactive -gpu "num=4:gmodel=TeslaV100_SXM2_32GB" -a 'docker(registry.gsc.wustl.edu/cpohl/parabricks:v3.5.0_beta2)' \
