...
project_name=$1
IN_DIR=/storage1/fs1/jin810/Active/pb_runs/"$project_name"/haplotypecaller/full_mem
OUT_DIR=/storage1/fs1/jin810/Active/pb_runs/"$project_name"/creategenomicsdb/full_mem
TMP_DIR=/scratch1/fs1/jin810/pb_runs_scratch/"$project_name"/creategenomicsdb/full_mem
